...
L<Apache::Compress> (in conjuction with L<Apache::Filter>) and
L<Apache::GzipChain> (in conjunction with L<Apache::OutputChain>). All
three can handle static files. L<Apache::Dynagzip> has recipes how to
work with L<CGI> or L<Apache::Registry> scripts).
