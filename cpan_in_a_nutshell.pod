...
To hide modules for testing purposes, there are two modules available:
L<Devel::Hide> and L<Test::Without::Module>. The latter has some
problems with Tk, so prefer the first one.
...
L<http://web.archive.org/web/20060507091304/http://idisk.mac.com/christian.hansen/Public/perl/serialize.pl> (this was originally 
...
=head1 SQL Abstrations

=head2 Schema handling
