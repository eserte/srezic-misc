...
The following modules have some support for locking:
L<File::Basic::Flock>, L<File::FcntlLock>, L<File::Flock>, a couple of
modules in the B<LockFile::> namespace (e.g. L<LockFile::Simple>),
L<Lazy::Lockfile>, L<Paranoid::Lockfile>.
