...
Using L<FFI> or L<C::DynaLib> C library functions may be used without
the need to write intermediate C code at all. Under Windows,
L<Win32::API> may be used to access the Windows API.
